 ...
 */
package com.norconex.committer.amazoncloudsearch.spi;

import static org.apache.commons.collections4.MultiMapUtils.newListValuedHashMap;

import org.apache.commons.collections4.MultiValuedMap;

import com.norconex.committer.amazoncloudsearch.AmazonCloudSearchCommitter;
 ...
 * </p>
 */
public class AmazonCloudSearchCommitterPtProvider
    ...
    public MultiValuedMap<Class<?>, Class<?>> getPolymorphicTypes() {
        ...
        map.put(Committer.class, AmazonCloudSearchCommitter.class);
        return map;
    }
}
