 ...
 */
package com.norconex.committer.solr.spi;
...
import com.norconex.committer.solr.SolrCommitter;
 ...
 * </p>
 */
public class SolrCommitterPtProvider
    ...
    public MultiValuedMap<Class<?>, Class<?>> getPolymorphicTypes() {
        ...
        map.put(Committer.class, SolrCommitter.class);
        return map;
    }
}
