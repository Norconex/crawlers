 ...
 */
package com.norconex.committer.idol.spi;
...
import com.norconex.committer.idol.IdolCommitter;
 ...
 * </p>
 */
public class IdolCommitterPtProvider
    ...
    public MultiValuedMap<Class<?>, Class<?>> getPolymorphicTypes() {
        ...
        map.put(Committer.class, IdolCommitter.class);
        return map;
    }
}
