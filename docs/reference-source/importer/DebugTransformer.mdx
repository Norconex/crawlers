...
<ReferenceExamples
  examples={[
    {"title":"default","description":"The following logs the value of any `document.reference` and `document.title` document metadata fields.","codeByLanguage":{"json":"{\n  \"handler\": {\n    \"class\": \"DebugTransformer\",\n    \"logFields\": [\n      \"document.reference\",\n      \"document.title\"\n    ],\n    \"logLevel\": \"INFO\"\n  }\n}","yaml":"handler:\n  class: DebugTransformer\n  logFields:\n    - document.reference\n    - document.title\n  logLevel: INFO","xml":"<handler>\n  <class>DebugTransformer</class>\n  <logFields>\n    <logField>document.reference</logField>\n    <logField>document.title</logField>\n  </logFields>\n  <logLevel>INFO</logLevel>\n</handler>"}}
  ]}
/>
