...
lookup = {
    ...
    ('CrawlerConfig.mdx', 'maxDocuments'): 'Maximum total number of documents to process across all crawl runs combined.',
    ('CrawlerConfig.mdx', 'maxDocumentsPerRun'): 'Maximum number of documents to process in a single crawl run.',
    ('CrawlerConfig.mdx', 'maxRunDocuments'): 'Maximum number of documents to process in a single crawl run.',
