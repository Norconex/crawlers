...
<ReferenceExamples
  examples={[
    {"title":"default","description":"The following example uses the minimum required settings to configure Elasticsearch (or AWS OpenSearch) Committer.","codeByLanguage":{"json":"{\n  \"class\": \"ElasticsearchCommitter\",\n  \"indexName\": \"some_index\"\n}","yaml":"class: ElasticsearchCommitter\nindexName: some_index","xml":"<committer>\n  <class>ElasticsearchCommitter</class>\n  <indexName>some_index</indexName>\n</committer>"}}
  ]}
/>
