...
import static com.norconex.grid.core.compute_DELETE.GridComputeState.COMPLETED;
import static com.norconex.grid.core.compute_DELETE.GridComputeState.FAILED;
import static com.norconex.grid.core.compute_DELETE.GridComputeState.IDLE;
import static com.norconex.grid.core.compute_DELETE.GridComputeState.RUNNING;
...
class GridComputeStateTest {
    ...
    @Test
    void testHasRan() {
        assertThat(IDLE.isTerminal()).isFalse();
