 ...
 */
package com.norconex.grid.core.spi;
 ...
 * </p>
 */
public class CoreGridPtProvider extends BasePolymorphicTypeProvider {

    @Override
    protected void register(Registry r) {
        r.add(GridConnector.class, CoreGridConnector.class);
    }
}
