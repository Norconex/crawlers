...
public interface GridCompute {
    ...
    default JobState runOn(
            @NonNull RunOn runOn,
            @NonNull String jobName,
            @NonNull Runnable callable) {
        return switch (runOn) {
     ...
     * {@link #runOnOneOnce(String, Runnable)}, the same task can be launch
     ...
     */
    JobState runOnOne(String jobName, Runnable runnable)
            throws GridException;
     ...
     * {@link Runnable} when on the node that executed it. Else, the future
     ...
     */
    JobState runOnOneOnce(String jobName, Runnable runnable)
            throws GridException;
     ...
     * @throws GridException
     */
    JobState runOnAll(String jobName, Runnable runnable)
            throws GridException;

    JobState runOnAllOnce(String jobName, Runnable runnable)
            throws GridException;
     ...
     * @throws GridException
     */
    JobState runOnAllSynchronized(String jobName, Runnable runnable)
            throws GridException;
}
