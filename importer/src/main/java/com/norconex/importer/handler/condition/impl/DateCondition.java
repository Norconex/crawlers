...
//        configuration.getFieldMatcher().copyFrom(fieldMatcher);
//    }
...
//                    unit, amount, today, configuration.getConditionZoneId());
//            }
...
//                .format(dateFormat)
//                .zoneId(valueHasZone
//                        ? null : configuration.getConditionZoneId())
//                .build()
//                .parse(d);
...
//        fieldMatcher.saveToXML(xml.addEconfiguration.getValueMatcher()dMatcher"));
...
//    }
//
//    private DateValueMatcher toValueMatcher(XML xml) {
...
//        try {
//            return new DateValueMatcher(operator, toDateTimeSupplier(date));
