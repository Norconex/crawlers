            ...
            try {
                if (w != null) {
                    ...
                    if (currentPath.equals(splitPath)) {
                        ...
                        var childDoc = new Doc(finalRef, out.getInputStream(),
                                childMeta);
                        ...
                        childInfo
                                .addEmbeddedParentReference(xmlDoc.reference());
                        childMeta.set(DocMetaConstants.EMBEDDED_REFERENCE,
                                embedRef);
                ...
                throw new SAXException(
                        "Cannot parse XML for document: " + xmlDoc.reference(),
                        e);
            }
