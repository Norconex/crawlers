...
public class TruncateTransformer implements
    ...
    public void doBody(DocContext docCtx) throws ImporterHandlerException {
        ...
        try (var reader = IOUtils.buffer(docCtx.readContent().asReader());
                var writer = docCtx.writeContent().toWriter()) {
    ...
    public void doFields(DocContext docCtx) throws ImporterHandlerException {
