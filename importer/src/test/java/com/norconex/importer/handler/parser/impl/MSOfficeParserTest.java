...
class MSOfficeParserTest {
    ...
    void test_MSOffice_Word_docx() throws Exception {
        ParseAssertions.assertThat(
            ...
            .hasContentType("application/vnd.openxmlformats-officedocument."
    ...
    void test_MSOffice_Word_docm() throws Exception {
        ParseAssertions.assertThat(
            ...
            .hasContentType("application/vnd.ms-word.document.macroenabled.12")
            .hasContentFamily("Word Processor")
            .hasExtension("docm")
            .contains(CONTENT);
    }
    ...
    void test_MSOffice_Word_dotm() throws Exception {
        ParseAssertions.assertThat(
            ...
            .hasContentType("application/vnd.ms-word.template.macroenabled.12")
            .hasContentFamily("Word Processor")
            .hasExtension("dotm")
            .contains(CONTENT);
    }
    ...
    void test_MSOffice_PowerPoint_pptm() throws Exception {
        ParseAssertions.assertThat(
            ...
            .hasContentType("application/vnd.ms-powerpoint.presentation.macroenabled.12")
            .hasContentFamily("Presentation")
            .hasExtension("pptm")
            .contains(CONTENT);
    }
    ...
    void test_MSOffice_PowerPoint_potm() throws Exception {
        ParseAssertions.assertThat(
            ...
            .hasContentType("application/vnd.ms-powerpoint.template.macroenabled.12")
            .hasContentFamily("Presentation")
            .hasExtension("potm")
            .contains(CONTENT);
    }
    ...
    void test_MSOffice_PowerPoint_ppsm() throws Exception {
        ParseAssertions.assertThat(
            ...
            .hasContentType("application/vnd.ms-powerpoint.slideshow.macroenabled.12")
            .hasContentFamily("Presentation")
            .hasExtension("ppsm")
            .contains(CONTENT);
    }
    ...
    void test_MSOffice_Excel_xlam() throws Exception {
        ParseAssertions.assertThat(
            ...
            .hasContentType("application/vnd.ms-excel.addin.macroenabled.12")
            .hasContentFamily("Spreadsheet")
            .hasExtension("xlam")
            .contains(CONTENT);
    }
    ...
    void test_MSOffice_Excel_xlsm() throws Exception {
        ParseAssertions.assertThat(
            ...
            .hasContentType("application/vnd.ms-excel.sheet.macroenabled.12")
            .hasContentFamily("Spreadsheet")
            .hasExtension("xlsm")
            .contains(CONTENT);
    }
    ...
    void test_MSOffice_Excel_xltm() throws Exception {
        ParseAssertions.assertThat(
            ...
            .hasContentType("application/vnd.ms-excel.template.macroenabled.12")
            .hasContentFamily("Spreadsheet")
            .hasExtension("xltm")
            .contains(CONTENT);
    }
