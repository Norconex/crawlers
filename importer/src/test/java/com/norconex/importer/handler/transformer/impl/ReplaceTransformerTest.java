...
class ReplaceTransformerTest {
    ...
    void testWriteRead() throws IOException {
        ...
        try (Reader reader = new InputStreamReader(IOUtils.toInputStream(
    ...
    void testNoValue()
        ...
        t.getConfiguration().setOperations(List.of(
            ...
            new ReplaceOperation()
                ...
                .setToField("regex")
                .setValueMatcher(regex("\\s+b\\s+").setPartial(true))
                .setToValue("")
    ...
    @Test
        ...
        t.getConfiguration().setOperations(List.of(
            ...
            new ReplaceOperation()
                .setValueMatcher(basic("fromValue1").setIgnoreCase(true))
                .setToValue("toValue1")
            ...
            new ReplaceOperation()
                .setValueMatcher(regex("fromValue3").setIgnoreCase(true))
                .setToValue("toValue3")
    ...
    void testRegularReplace() throws IOException {
        ...
        t.getConfiguration().setOperations(List.of(
            ...
            new ReplaceOperation()
            .setValueMatcher(basic("value Of mixed case").setIgnoreCase(true))
            .setToValue("REPLACED")
    ...
    void testRegexReplace() throws IOException {
        ...
        t.getConfiguration().setOperations(List.of(
            new ReplaceOperation()
                .setValueMatcher(regex("(.*)/.*").setPartial(true))
                .setToValue("$1")
            ...
            new ReplaceOperation()
                .setValueMatcher(regex("file")
                        .setPartial(true).setIgnoreCase(true))
    ...
    void testWholeAndPartialMatches()
        ...
        t.getConfiguration().setOperations(List.of(
            ...
            new ReplaceOperation()
                .setValueMatcher(basic("One DOG, two DOGS, three DOGS")
                        .setIgnoreCase(true))
            ...
            new ReplaceOperation()
                .setValueMatcher(regex("One dog").setIgnoreCase(true))
                .setToValue("One cat")
                .setFieldMatcher(basic("field"))
    ...
    void testReplaceAll()
        ...
        t.getConfiguration().setOperations(List.of(
            ...
            new ReplaceOperation()
                .setValueMatcher(basic("dog")
                        .setReplaceAll(true).setIgnoreCase(true))
                .setToValue("cat")
                .setFieldMatcher(basic("field"))
    ...
    void testOnSet()
        ...
        t.getConfiguration().setOperations(List.of(
            ...
            new ReplaceOperation()
                ...
                .setToField("target1")
                .setValueMatcher(regex("value").setPartial(true))
