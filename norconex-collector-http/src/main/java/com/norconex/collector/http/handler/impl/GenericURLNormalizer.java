...
/**
 * @deprecated use 
 *      {@link com.norconex.collector.http.url.impl.GenericURLNormalizer}
 */
@Deprecated
public class GenericURLNormalizer 
        extends com.norconex.collector.http.url.impl.GenericURLNormalizer {

    private static final long serialVersionUID = 1325469512864235079L;
