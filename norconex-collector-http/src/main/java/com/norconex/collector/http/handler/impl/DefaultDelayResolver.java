...
/**
 * @deprecated use 
 *          {@link com.norconex.collector.http.delay.impl.DefaultDelayResolver}
 */
@Deprecated
public class DefaultDelayResolver 
        extends com.norconex.collector.http.delay.impl.DefaultDelayResolver {
    private static final long serialVersionUID = -1282004258350564103L;
    ...
    public void delay(RobotsTxt robotsTxt, String url) {
        LOG.warn("DEPRECATED: use "
            + "com.norconex.collector.http.delay.impl.DefaultDelayResolver "
            + "instead of "
