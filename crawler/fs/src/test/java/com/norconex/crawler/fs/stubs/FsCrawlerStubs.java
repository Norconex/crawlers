...
public final class FsCrawlerStubs {

    public static final String CRAWLER_ID = FsCrawlerConfigStubs.CRAWLER_ID;

    private FsCrawlerStubs() {}
    ...
    public static CrawlerBuilder memoryCrawlerBuilder(
        ...
        var b = SneakyFsCrawler
                .builder()
                .configuration(
                        FsCrawlerConfigStubs.memoryCrawlerConfig(workDir));
        if (c != null) {
