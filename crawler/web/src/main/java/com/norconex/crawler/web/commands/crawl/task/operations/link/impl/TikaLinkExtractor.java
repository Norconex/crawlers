...
public class TikaLinkExtractor
    ...
    @Override
    public Set<com.norconex.crawler.web.commands.crawl.task.operations.link.Link> extractLinks(
            CrawlDoc doc)
            throws IOException {
        ...
        Set<com.norconex.crawler.web.commands.crawl.task.operations.link.Link> nxLinks =
                new HashSet<>();
    ...
    private void extractTikaLinks(
        ...
        try (is) {
            ...
            Optional.ofNullable(
                    ...
                    .map(url -> {
                        var nxLink =
                                new com.norconex.crawler.web.commands.crawl.task.operations.link.Link(
                                        url);
    ...
    private Optional<
            com.norconex.crawler.web.commands.crawl.task.operations.link.Link> toNxLink(
        ...
        if (StringUtils.isNotBlank(extractedURL)) {
            var nxLink = new com.norconex.crawler.web.commands.crawl.task.operations.link.Link(
                    extractedURL);
            nxLink.setReferrer(referrerUrl);
    ...
    private void tikaMetaToNxMeta(
            com.norconex.crawler.web.commands.crawl.task.operations.link.Link nxLink,
            Link tikaLink) {
