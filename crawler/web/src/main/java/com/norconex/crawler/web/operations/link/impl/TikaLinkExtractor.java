 ...
 */
package com.norconex.crawler.web.operations.link.impl;
...
public class TikaLinkExtractor
    ...
    @Override
    public Set<com.norconex.crawler.web.operations.link.Link>
            extractLinks(
                    CrawlDoc doc)
                    throws IOException {
        ...
        Set<com.norconex.crawler.web.operations.link.Link> nxLinks =
                new HashSet<>();
    ...
    private void extractTikaLinks(
        ...
        try (is) {
            ...
            Optional.ofNullable(
                    ...
                    .map(url -> {
                        var nxLink =
                                new com.norconex.crawler.web.operations.link.Link(
                                        url);
    ...
    private Optional<
            com.norconex.crawler.web.operations.link.Link> toNxLink(
    ...
    private void tikaMetaToNxMeta(
            com.norconex.crawler.web.operations.link.Link nxLink,
            Link tikaLink) {
