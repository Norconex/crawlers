...
public class TikaLinkExtractor
    ...
    public Set<com.norconex.crawler.web.cmd.crawl.operations.link.Link> extractLinks(
        ...
        Set<com.norconex.crawler.web.cmd.crawl.operations.link.Link> nxLinks =
                new HashSet<>();
    ...
    private Optional<
            com.norconex.crawler.web.cmd.crawl.operations.link.Link> toNxLink(
    ...
    private void tikaMetaToNxMeta(
            com.norconex.crawler.web.cmd.crawl.operations.link.Link nxLink,
            Link tikaLink) {
