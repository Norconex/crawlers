 ...
 */
package com.norconex.crawler.web.pipelines;
...
import com.norconex.crawler.web.pipelines.committer.stages.PostImportLinksStage;
import com.norconex.crawler.web.pipelines.importer.WebImporterPipelineContext;
import com.norconex.crawler.web.pipelines.importer.stages.CanonicalStage;
import com.norconex.crawler.web.pipelines.importer.stages.DelayResolverStage;
import com.norconex.crawler.web.pipelines.importer.stages.HttpFetchStage;
import com.norconex.crawler.web.pipelines.importer.stages.LinkExtractorStage;
import com.norconex.crawler.web.pipelines.importer.stages.RecrawlableResolverStage;
import com.norconex.crawler.web.pipelines.importer.stages.RobotsMetaCreateStage;
import com.norconex.crawler.web.pipelines.importer.stages.RobotsMetaNoIndexStage;
import com.norconex.crawler.web.pipelines.queue.stages.RobotsTxtFiltersStage;
import com.norconex.crawler.web.pipelines.queue.stages.SitemapResolutionStage;
import com.norconex.crawler.web.pipelines.queue.stages.UrlNormalizerStage;

public final class WebPipelines {

    private WebPipelines() {
    }

    public static CrawlerPipelines create() {
        return CrawlerPipelines.builder()
