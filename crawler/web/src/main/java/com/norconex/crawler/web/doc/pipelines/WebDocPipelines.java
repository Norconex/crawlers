...
import com.norconex.crawler.core.tasks.crawl.pipelines.committer.stages.DocumentDedupStage;
import com.norconex.crawler.core.tasks.crawl.pipelines.committer.stages.DocumentPostProcessingStage;
...
import com.norconex.crawler.core.tasks.crawl.pipelines.importer.stages.DocumentPreProcessingStage;
import com.norconex.crawler.core.tasks.crawl.pipelines.importer.stages.ImportModuleStage;
...
public final class WebDocPipelines {
    ...
    private static final DocPipelines PIPELINE = DocPipelines.builder()
