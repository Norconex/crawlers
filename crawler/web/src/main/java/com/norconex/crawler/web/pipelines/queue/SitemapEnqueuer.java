 ...
 */
package com.norconex.crawler.web.pipelines.queue;
...
import com.norconex.crawler.core.init.queue.QueueInitContext;
import com.norconex.crawler.core.init.queue.ReferenceEnqueuer;
import com.norconex.crawler.web.doc.WebCrawlDocContext;
import com.norconex.crawler.web.operations.sitemap.SitemapContext;
...
public class SitemapEnqueuer implements ReferenceEnqueuer {
    ...
    @Override
    public int enqueue(QueueInitContext queueInitCtx) {
