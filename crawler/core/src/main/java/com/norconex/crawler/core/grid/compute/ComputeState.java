...
enum ComputeState {
    IDLE, RUNNING, DONE, /*EXPIRED,*/ FAILED;
    ...
    boolean hasRan() {
        return this == ComputeState.DONE
                || this == ComputeState.FAILED;
    }

    boolean isAny(ComputeState... states) {
        if (states == null) {
            return false;
        }
     ...
     * @return state
     */
    static ComputeState of(String state) {
