...
/**
 * <p>
 * Generic way of storing arbitrary objects in memory.
 ...
 * </p>
 * <p>
 * This class mainly makes it easier for developers to store ad-hoc data in
 * their own extensions of an existing crawler implementation
 * so multiple components can easily share said data when needed.
 * </p>
 * <p>
 * If there is a need for persistence between crawler executions, use
 * grid storage instead.
 * </p>
 */
@EqualsAndHashCode
@ToString
public class CrawlerSessionAttributes {
