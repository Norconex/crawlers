...
final class CrawlerCommandExecuter {
    ...
    //        }
    //
    //        crawler.gridExecuter = new IgniteGridExecuter();
    //        crawler.gridExecuter.init(crawler);
    //
    //        crawler.gridExecuter.execute(
    //                () -> System.out
    //                        .println(
    //                                "XXX ENTERING INIT.....: "),
    //                GridExecuterOptions.builder().name("ENTERING").build());
    //        //        compute.broadcast();
    //
    //        crawler.gridExecuter.execute(() -> {
    ...
    //        private boolean singleton; // true= run on a single node of a cluster
