...
public class CrawlerTestHarnessResult {
    @Getter
    private final Map<String, CrawlerTestNodeOutput> nodeOutputs;
    ...
    public CrawlerTestNodeOutput getNodeOutput(String nodeName) {
