...
class OnMatchFiltersResolverTest {
    ...
    void testIsRejectedByMetadataFilters() {
        ...
        crawlerContext.getPipelines().getImporterPipeline().apply(ctx1);
        ...
        crawlerContext.getPipelines().getImporterPipeline().apply(ctx2);
        ...
        crawlerContext.getPipelines().getImporterPipeline().apply(ctx3);
