...
class CrawlerTest {
    ...
    void testCrawlerError() {
        ...
        var mem = CrawlerTestUtil.runWithConfig(tempDir, cfg ->
    ...
    void testDocumenetError() {
        ...
        var mem = CrawlerTestUtil.runWithConfig(tempDir, cfg ->
            cfg.setStartReferences(List.of("ref1", "ref2", "ref3"))
            .setNumThreads(2)
            .setStopOnExceptions(List.of(IllegalStateException.class))
            .addEventListener(evt -> {
    ...
    void testOrphanDeletion() {
        ...
        // New session with 1 new 2 modified, and 1 orphan
        crawler = CrawlerStubs.memoryCrawler(tempDir, cfg ->
            cfg.setStartReferences(List.of(
                    "mock:ref2", "mock:ref3", "mock:ref4", "mock:ref5"))
