 ...
 */
package com.norconex.crawler.core2.doc.operations.checksum;
 ...
 * metadata field name {@link CrawlDocMetaConstants#CHECKSUM_DOC}.
 * </p><p>
    ...
    public final String createDocumentChecksum(Doc document) {
        ...
        if (getConfiguration().isKeep()) {
            ...
            if (StringUtils.isBlank(field)) {
                field = CrawlDocMetaConstants.CHECKSUM_DOC;
            }
